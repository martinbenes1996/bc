...
// setters
void setSampleFrequency(int val) { sampleFrequency = val; renewSamplePeriod(); }
void setSendFrequency(int val) { sendFrequency = val; renewSendPeriod(); }
void setSamplePeriod(int val) { setSampleFrequency(1000/val); }
void setSendPeriod(int val) { setSendFrequency(1000/val); }
...
void handleSample() {
  ...
  if (server.arg("period") != "") {
    if(fwas){ server.send(400, "text/plain", "400: Bad request"); return; }
