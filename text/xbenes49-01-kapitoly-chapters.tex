...
Even though in the last years a number of articles has been written on the topic of localization
using PIR, it is still a matter of intense research. This research will suggest a possible approach,
a heat signal processing pipeline, to evaluate the situation in the sensed area. The multiple
sensors can be used. At the second part, designed algorithms will be implemented, tested and
the results of tests will be presented.

This topic was suggested as part of ongoing research aimed on integration of technology and
buildings and smart housing by a research group Nutzerzentrierte Technologien in Fachhochschule
Vorarlberg in Dornbirn in Austria under the direct supervisory of a lead researcher prof. Guido Kempter.
The research and the thesis were made during the study program Erasmus+ in at the University of Applied
Sciences in Vorarlberg (FH Vorarlberg).
...
The prerequisite of comprehension of a PIR sensors principle more deeply is to understand
several fields of study -- physics of radiation, different methods, how is the radiation,
of wavelengths in the infrared spectrum in particular, perceived by machines. In this chapter
all this is introduced. For the context the principle of the human body heat perception is described as well. 
...
The peak wavelength (temperature $37^{\circ}C$ or $310.15K$) can be calculated with the Wien's displacement law.
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.7\textwidth]{img/bodyradiation.png}
...
$\lambda \in \langle 380nm;760nm \rangle$ called visible light, one of the~bands of an~electromagnetic spectrum.
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.7\textwidth]{img/skin.jpg}
...
radiation at~wavelength $\lambda\in \langle 700nm;2.5mm \rangle$ aka frequency $f\in \langle 120MHz;430THz \rangle$. \cite{an2105}

\paragraph{Principles of PIR sensors}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.2\textwidth]{img/pirscheme.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=1\textwidth]{img/roomsegments.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.9\textwidth]{img/featureextraction.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.35\textwidth]{img/linear.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.6\textwidth]{img/3pir_geometry.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.7\textwidth]{render/fuzzysets.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=1\textwidth]{render/signallines.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.7\textwidth]{img/circularsector_transformation.png}
...
\end{equation}
\begin{equation}
M_{<0^{\circ}, <T} = N(A^{\kappa = left}) \land_P A^{\kappa = distance}
\end{equation}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.4\textwidth]{img/pir_area.png}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=0.5\textwidth]{img/area_triangles.png}
...
\paragraph{Global area representation}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=0.6\textwidth]{img/global_area.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=1\textwidth]{img/pirstd.png}
...
During the testing $100k\Omega$ resistors were used. The circuit is shown in the figure \ref{fig:PIRcircuit}.
...
\draw %(2,0)
  ...
  (1,1.5) to[short]
  (7,1.5) to[short, l={\tiny $5V$}, -o] (8,1.5)
  % signal
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=0.6\textwidth]{render/circuitboard.png}
...
area into $10^{\circ} = \frac{\pi}{18}$ circular sectors. Object moving around the sensor in the distance $0.5m$
with speed $15km.h^{-1} = 4.1667m.s^{-1}$ (very fast run) passes the central circular sector in

\begin{equation}
t = \frac{s}{v} = \frac{0.5*tg(10^{\circ})}{4.1667} = 0.02116s
\end{equation}

This means the frequency of the movement through the circular sectors is

\begin{equation}
f = \frac{1}{t} = \frac{1}{0.02116} = 47.259Hz
\end{equation}
...
Rounding up gives us minimal sampling frequency $100Hz$, or sampling period $10ms$.
resulting with $2B$ sample in throughput $\mu$

\begin{equation}
\mu = F_s * |\text{sample}| * 8\frac{bit}{byte} = 100 * 2 * 8 = 1.6kbps
\end{equation}
...
(multicast, HTTP) and EEPROM library to operate EEPROM persistent memory. External library was used
for functionality of web interface for initialization of WiFi of module.
...
\section{REST API of MCU HTTP server}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=0.9\textwidth]{img/class_src.png}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=0.87\textwidth]{img/class_segment.png}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=1\textwidth]{img/class_model.png}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=1\textwidth]{render/gui.png}
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=0.4\textwidth]{render/record.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=1\textwidth]{render/signal_calm.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=1\textwidth]{render/signal_walk.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.85\textwidth]{img/walk03.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=1\textwidth]{img/labeling2.png}
...
negative means absence, for distance it is body being further than $4.5m$ when positive, closer when negative.
...
15s recordings were done, each then splitted into 10 - 30 artefacts, which each possess a separate
