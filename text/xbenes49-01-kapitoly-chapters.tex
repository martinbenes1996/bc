...
These traits are directly dependent on the labelling. With a sufficient number of training
...
{\it Interpretation of results. Practical usage. }
...
As the programming language used for the Monitor was Python3 due to many libraries connected with the
machine learning and classification (numpy, scipy, matplotlib), for GUI was chosen library {\it TKinter} -- as a part of
standard Python3 library is always present whenever Python3 is present, the usage is pretty simple
and it is easy to connect with matplotlib. The whole GUI is still designed as a prototype,
