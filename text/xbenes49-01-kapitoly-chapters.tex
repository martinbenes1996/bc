...
Operation, that is often used is using single smoothening filter with a memory, which 
...
Optimalization of parameters in postprocessing smoothing function showed

Parameters $-0.085$ and $-0.0025$, results $84.506$ and $88.3344$, altogether $87.0651$.

Distance $-0.001$ and $-0.1$, results $78.281$ and $72.977$, altogether ?, not used 4m\_ and 5m\_* for training and testing.

\begin{table}[!ht]
\begin{center}
\begin{tabular}{|c|c c c c|} \hline
\textbf{Aspect} & \textbf{Presence} & \textbf{Distance} & \textbf{Center} & \textbf{Left} \\ \hline
Positive rate   & $84.506$          & $78.281$         & $$              & $$             \\
Negative rate   & $88.3344$         & $72.977$         & $$              & $$             \\ \hline
Total rate      & $87.0651$         & $$               & $$              & $$             \\ \hline
\end{tabular}
\caption{Resulting accurracy on testing data.\label{table:3stateLogicOp} }
\end{center}
\end{table}
