...
area matrix representation. Formula \ref{eq:2triangles} specifies how to compute
size of areas intersection of two triangles. If the global area is split into
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.9\textwidth]{render/gui.png}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=0.9\textwidth]{render/record.png}
...
The classifiers were trained with supervisor. To do so, a train and test data set wer recorded and labelled with simple labelling method,
